...
(function () {
  ...
  function showImageDialog(callback, options = {}) {
        ...
        <div style="padding: 20px; overflow-y: auto; flex: 1;">
          ...
          <div id="cloudinary-browse-view" style="display: block;">
            <div id="cloudinary-folder-nav" style="margin-bottom: 12px; padding: 8px 12px; background: #f8f9fa; border-radius: 8px; font-size: 13px; color: #7f8c8d; display: flex; align-items: center; gap: 6px;">
              ...
              <span id="folder-breadcrumb" style="flex: 1;">cororaro</span>
            </div>
          ...
          <div id="cloudinary-url-input" style="display: none;">
            ...
            <input type="text" id="cloudinary-url-field" placeholder="https://res.cloudinary.com/... o cororaro/..." style="width: 100%; padding: 12px; border: 1px solid #e1e8ed; border-radius: 8px; font-size: 14px;">
    ...
    let currentFolder = folder || 'cororaro';
    ...
    async function loadCloudinaryImages(folderPath) {
      ...
      try {
        // Load subfolders
        const subfoldersUrl = `/admin/cloudinary/subfolders?path=${encodeURIComponent(folderPath)}`;
        const subfoldersResponse = await fetch(subfoldersUrl);
        const subfoldersData = await subfoldersResponse.json();

        // Load images
        const imagesUrl = `/admin/cloudinary/images?folder=${encodeURIComponent(folderPath)}&maxResults=100`;
    ...
    async function handleUpload(file) {
      ...
      try {
        const result = await upload(file, {
          ...
          folder: folder || 'cororaro/newsletter'
        });
